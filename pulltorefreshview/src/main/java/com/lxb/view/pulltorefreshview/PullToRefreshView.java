package com.lxb.view.pulltorefreshview;
...
public class PullToRefreshView extends LinearLayout {
    ...
    private void headerPrepareToRefresh(int deltaY) {
        ...
        if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
            mHeaderTextView.setText(R.string.pulltorefreshview_header_hint_ready);
            ...
            mHeaderImageView.startAnimation(mFlipAnimation);
            // mHeaderImageView.
            mHeaderTextView.setText(R.string.pulltorefreshview_header_hint_normal);
    ...
    private void footerPrepareToRefresh(int deltaY) {
        ...
        if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
            ...
            mFooterTextView
                    .setText(R.string.pulltorefreshview_footer_hint_ready);
            ...
            // mFooterImageView.clearAnimation();
            // mFooterImageView.startAnimation(mFlipAnimation);
            mFooterTextView.setText(R.string.pulltorefreshview_footer_hint_ready);
    ...
    public void headerRefreshing() {
        ...
        mHeaderTextView.setText(R.string.pulltorefreshview_header_hint_loading);
    ...
    private void footerRefreshing() {
        ...
        mFooterTextView
                .setText(R.string.pulltorefreshview_header_hint_loading);
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderImageView.setImageResource(R.drawable.pulltorefreshview_arrow);
        mHeaderTextView.setText(R.string.pulltorefreshview_header_hint_normal);
