...
final class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(activity.getHandler(), ZXingConstant.decode_succeeded, rawResult);
            ...
            Message message = Message.obtain(activity.getHandler(), ZXingConstant.decode_failed);
            message.sendToTarget();
        }
    }
