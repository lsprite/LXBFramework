...
public class ScreenShot {
    ...
    public static Bitmap takeScreenShot(Activity activity) {
        ...
        savePic(b, DirCache.createCachePath(activity, "/screen_test.png"));
        return b;
    }
    ...
    public static void shoot(Activity a) {
        ScreenShot.savePic(ScreenShot.takeScreenShot(a), DirCache.createCachePath(a, "/screen_test.png"));
    }
...
//            scrollView.getChildAt(i).setBackgroundResource(R.drawable.bg3);
        ...
        try {
            out = new FileOutputStream(DirCache.createCachePath(context, "/screen_test.png"));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        try {
     ...
     * 截图listview
     **/
    public static Bitmap getbBitmap(Context context, ListView listView) {
        int h = 0;
        Bitmap bitmap = null;
        // 获取listView实际高度
