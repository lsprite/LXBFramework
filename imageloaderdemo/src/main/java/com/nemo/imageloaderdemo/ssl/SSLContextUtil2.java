...
import com.nemo.imageloaderdemo.MyApplication;
...
public class SSLContextUtil2 {
    public static SSLContext getSSLContext() throws Exception {

        InputStream inputStream = MyApplication.getInstance()
                .getApplicationContext().getResources().getAssets()
                .open("xj.p12");

        TrustManager[] trustManagers = prepareTrustManager(MyApplication
                .getInstance().getApplicationContext().getResources()
                .getAssets().open("ca.cer"));
        KeyManager[] keyManagers = prepareKeyManager(inputStream,
                "cau2FhDHu2SOQuigJZQ58Z/ICsNDb9Nc");
