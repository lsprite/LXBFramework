...
public class ProgressView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (!linkedList.isEmpty()) {
			...
			// 绘制三秒处的断点
			if (linkedList.getLast() <= 1000)
				canvas.drawRect(perPixel * 1000, 0, perPixel * 1000
						+ threeWidth, getMeasuredHeight(), threePaint);
		} else
			// 绘制三秒处的断点
			canvas.drawRect(perPixel * 1000, 0, perPixel * 1000 + threeWidth,
					getMeasuredHeight(), threePaint);// 绘制三秒处的矩形
